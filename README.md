...
**✅ 最佳适用场景**：
- **项目开发**：长期迭代的软件项目，有明确的代码库、技术栈和开发历史
- **团队协作**：多人参与的项目，需要统一的知识管理和上下文共享
- **复杂系统**：包含多个模块、配置和架构决策的大型项目

**⚠️ 效果有限的场景**：
- **普通对话**：日常闲聊、简单问答、一次性任务
- **短期任务**：单次执行、无后续迭代的临时任务
- **非项目环境**：没有明确代码库或项目结构的通用对话

**💡 使用建议**：
- 在项目上下文中使用效果最佳，能显著减少 Token 消耗并提高 Agent 准确性
- 普通对话中使用效果有限，建议仅在项目相关讨论中激活
